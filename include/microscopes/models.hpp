...
public:
  ...
  virtual void add_value(const model &m, const row_accessor &value, rng_t &rng) = 0;
  virtual void remove_value(const model &m, const row_accessor &value, rng_t &rng) = 0;
  virtual float score_value(const model &m, const row_accessor &value, rng_t &rng) const = 0;
  virtual float score_data(const model &m, rng_t &rng) const = 0;
  virtual void sample_value(const model &m, row_mutator &value, rng_t &rng) const = 0;

  virtual suffstats_bag_t get_ss() const = 0;
  virtual void set_ss(const suffstats_bag_t &ss) = 0;
};
...
public:
  ...
  virtual std::shared_ptr<feature_group> create_feature_group(rng_t &rng) const = 0;

  virtual hyperparam_bag_t get_hp() const = 0;
  virtual void set_hp(const hyperparam_bag_t &hp) = 0;
...
public:
  ...
  std::shared_ptr<feature_group> create_feature_group(rng_t &rng) const override;
  ...
  void
  set_hp(const hyperparam_bag_t &hp) override
  {
...
public:
  ...
  void
  add_value(const model &m, const row_accessor &value, rng_t &rng) override
  {
    repr_.add_value(shared_repr(m), value.get< typename T::Value >(), rng);
  }

  void
  remove_value(const model &m, const row_accessor &value, rng_t &rng) override
  {
    repr_.remove_value(shared_repr(m), value.get< typename T::Value >(), rng);
  }

  float
  score_value(const model &m, const row_accessor &value, rng_t &rng) const override
  {
    return repr_.score_value(shared_repr(m), value.get< typename T::Value >(), rng);
  }

  float
  score_data(const model &m, rng_t &rng) const override
  {
    return repr_.score_data(shared_repr(m), rng);
  }

  void
  sample_value(const model &m, row_mutator &value, rng_t &rng) const override
  {
  ...
  void
  set_ss(const suffstats_bag_t &ss) override
  {
...
distributions_model<T>::create_feature_group(rng_t &rng) const
{
